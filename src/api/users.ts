...
function resolveApiBase(): string {
  ...
  if (!base && typeof window !== "undefined") {
    ...
    console.warn("[users api] Falling back to window.location.origin:", base);
  }
...
if (!API_BASE) {
  // eslint-disable-next-line no-console
  console.warn(
    "[users api] API_BASE unresolved. Ensure VITE_API_URL or REACT_APP_API_URL set and dev server restarted."
  );
} else {
  // eslint-disable-next-line no-console
  console.info("[users api] Using API_BASE =", API_BASE);
}
